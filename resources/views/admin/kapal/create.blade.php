    ...
    <div class="container-fluid">
        ...
        <main class="form-signin w-25 m-auto mt-4">
            <div class="card p-3 m-2 ">
                ...
                <form method="post" action="{{route('KategoriRetribusi.store')}}"> 
                    @csrf
                  <h1 class="h3 mb-3 fw-normal">tambah Kategori</h1>
              
                  <div class="form-floating mb-3">
                    <input type="text" class="form-control" id="floatingInput" name="kategori" placeholder="Kategori 1">
                    <label for="floatingInput">Kategori Retribusi</label>
                  </div> 
                  
                  <button class="btn btn-primary w-50 py-2 " type="submit">Tambah</button>
<br>
                </form>
            </div>
