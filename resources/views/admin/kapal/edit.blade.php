            ...
            <div class="col-sm-3 col-xl-3  pt-5 ps-2 ms-5 ">
                <div class="card shadow">
                    <div class="bg-light rounded h-100 p-4">
                        ...
                        <form action="{{route('KapalWajibRetribusi.update', $kapal->id)}}" method="post" >
                            @csrf
                            @method('PUT')
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" value="{{ $kapal->nama_kapal }}" name="nama_kapal" class="form-control" id="floatingInput" >
                            ...
                            <div class="form-floating mb-3">
                                <input value="{{ $kapal->ukuran }}" type="text" name="ukuran" class="form-control" id="floatingInput" >
