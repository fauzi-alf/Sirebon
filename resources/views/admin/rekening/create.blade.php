            ...
            <div class="col-sm-3 col-xl-3  pt-5 ps-2 ms-5 ">
                <div class="card shadow">
                    <div class="bg-light rounded h-100 p-4">
                        <h6 class="mb-4">Tambah Data Rekenning Pembayaran</h6>
                        <form action="{{route('RekeningPembayaranRetribusi.store')}}" method="post" >
                            @csrf
                            <div class="form-floating mb-3">
                                <input type="text" name="nama_akun" class="form-control" id="floatingInput" value="">
                                <label for="floatingInput">Nama Pemilik </label>
                            </div>
                            <div class="form-floating mb-3">
                                <select class="form-select" id="floatingSelect" name="id_ref_bank" aria-label="Floating label select example">
                            ...
                            <div class="form-floating mb-3">
                                <input type="text" name="no_rekening" class="form-control" id="floatingInput" >
                                <label for="floatingInput">No Rekening </label>
                            </div>
                            <button class="btn btn-primary btn-sm p-1" type="submit">Simpan</button>
                            <a href="{{ route('RekeningPembayaranRetribusi.index') }}" class="btn btn-danger btn-sm p-1"
