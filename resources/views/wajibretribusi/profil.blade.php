        ...
        <div class="sidebar pe-4 pb-3">
            <nav class="navbar bg-light navbar-light">
                ...
                <div class="navbar-nav w-100 p-2">
                    ...
                    @if (auth()->user()->level == 'wajibretribusi')
                        <a href="{{url('Laporan')}}" class="nav-item nav-link"><i class='bx bxs-report'></i> Laporan</a>
                    @endif
                    @if (auth()->user()->level == 'administrator')
                ...
                <div class="navbar-nav align-items-center ms-auto">
                    ...
                    <div class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end bg-light border-0 rounded-0 rounded-bottom m-0">  
                            @if (auth()->user()->level == 'wajibretribusi')
                                <a href="{{url('/Profile')}}" class="dropdown-item"><i class='bx bxs-user-account' ></i> My Profile</a>
                            @endif
